...
// configuration step. It creates a namespace called `DUME`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", DUME::cmake::project_name, DUME::cmake::project_version) };
